...
class SlicesDirInputSpec(FSLCommandInputSpec):
...
class SlicesDirOutputSpec(TraitedSpec):
...
class SlicesDir(FSLCommand):
    ...
    """
    _cmd = "slicesdir"
    input_spec = SlicesDirInputSpec
    output_spec = SlicesDirOutputSpec
    ...
    def _list_outputs(self):
        ...
        outputs["out_files"] = [
            self._gen_fname(basename=f, cwd=out_dir, ext=".png") for f in self.inputs.in_files
        ]
        return outputs
